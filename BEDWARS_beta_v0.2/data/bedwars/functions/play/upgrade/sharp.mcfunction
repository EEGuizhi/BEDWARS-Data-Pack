...
execute as @s[team=blue] if score blue_sharp num matches 1.. run give @s diamond 8
...
execute as @s[team=red] if score red_sharp num matches 1.. run give @s diamond 8
...
execute as @s[team=yellow] if score yellow_sharp num matches 1.. run give @s diamond 8
...
execute as @s[team=green] if score green_sharp num matches 1.. run give @s diamond 8
