...
execute as @s[team=blue] unless score blue_protect num matches 1 run give @s diamond 10
...
execute as @s[team=red] unless score red_protect num matches 1 run give @s diamond 10
...
execute as @s[team=yellow] unless score yellow_protect num matches 1 run give @s diamond 10
...
execute as @s[team=green] unless score green_protect num matches 1 run give @s diamond 10
