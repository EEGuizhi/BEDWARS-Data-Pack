...
# Trader1 Point
# execute store result score Tmp num run execute if entity @e[tag=trader1]
# execute unless score Tmp num matches 4 run tellraw @a [{"text":" [BED WARS] ","color":"gold"},{"text":" ERROR：","color":"red"},{"text":" 武器商人應為 4 ","color":"white"}]
# execute unless score Tmp num matches 4 run scoreboard players set error num 1

# Trader2 Point
# execute store result score Tmp num run execute if entity @e[tag=trader2]
# execute unless score Tmp num matches 4 run tellraw @a [{"text":" [BED WARS] ","color":"gold"},{"text":" ERROR：","color":"red"},{"text":" 隊伍商人應為 4 ","color":"white"}]
# execute unless score Tmp num matches 4 run scoreboard players set error num 1
...
execute if score error num matches 0 run scoreboard players set playing num 1
