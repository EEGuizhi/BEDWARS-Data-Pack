...
execute unless score playing num matches 1 run summon armor_stand ~ ~1 ~ {Tags:["bedwars","diamond"],Invisible:1b,NoGravity:1b,CustomName:'{"text":"鑽石生成點"}',CustomNameVisible:1b,ArmorItems:[{},{},{},{id:"diamond_block",Count:1b}]}
