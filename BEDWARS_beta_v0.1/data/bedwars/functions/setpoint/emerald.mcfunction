...
execute unless score playing num matches 1 run summon armor_stand ~ ~1 ~ {Tags:["bedwars","emerald"],Invisible:1b,NoGravity:1b,CustomName:'{"text":"綠寶石生成點"}',CustomNameVisible:1b,ArmorItems:[{},{},{},{id:"emerald_block",Count:1b}]}
