...
execute as @s[team=blue] run tellraw @a[team=blue] [{"text":" [BED WARS] ","color":"gold"},{"text":" 啟用了警報功能！","color":"aqua"}]
execute as @s[team=blue] as @a[team=blue] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
execute as @s[team=red] run tellraw @a[team=red] [{"text":" [BED WARS] ","color":"gold"},{"text":" 啟用了警報功能！","color":"aqua"}]
execute as @s[team=red] as @a[team=red] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
execute as @s[team=yellow] run tellraw @a[team=yellow] [{"text":" [BED WARS] ","color":"gold"},{"text":" 啟用了警報功能！","color":"aqua"}]
execute as @s[team=yellow] as @a[team=blue] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
execute as @s[team=green] run tellraw @a[team=green] [{"text":" [BED WARS] ","color":"gold"},{"text":" 啟用了警報功能！","color":"aqua"}]
