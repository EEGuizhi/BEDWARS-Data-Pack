...
execute if score blue_alive num matches 1.. run team modify display_blue_display suffix {"text":" ✓","color":"green"}
execute if score red_alive num matches 1.. run team modify display_red_display suffix {"text":" ✓","color":"green"}
execute if score yellow_alive num matches 1.. run team modify display_yellow_display suffix {"text":" ✓","color":"green"}
execute if score green_alive num matches 1.. run team modify display_green_display suffix {"text":" ✓","color":"green"}
