...
execute store result score @s Tmp run clear @s iron_chestplate{tag:{normal:1b}} 0
execute if score @s Tmp matches 1.. if score @s Armor matches ..5 run clear @s iron_chestplate{tag:{normal:1b}} 1
