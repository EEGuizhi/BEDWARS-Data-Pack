...
execute positioned ^ ^ ^5 run summon marker ~ ~ ~ {Tags:["fireball_motion","bedwars"]}
...
execute store result entity @s Motion[0] double 0.01 run scoreboard players get @s num
...
scoreboard players operation @s num -= @s Tmp
execute store result entity @s Motion[1] double 0.01 run scoreboard players get @s num
...
scoreboard players operation @s num -= @s Tmp
execute store result entity @s Motion[2] double 0.01 run scoreboard players get @s num
