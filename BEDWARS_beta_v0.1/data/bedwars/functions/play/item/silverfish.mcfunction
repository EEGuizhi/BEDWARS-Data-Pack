...
execute as @s[tag=bluefish_marker] unless score @s num matches 1 run summon silverfish ~ ~0.1 ~ {CustomName:'{"text":"藍隊蠹魚","color":"blue"}',CustomNameVisible:1b,Tags:["bedwars","no_loop"]}
execute as @s[tag=redfish_marker] unless score @s num matches 1 run summon silverfish ~ ~0.1 ~ {CustomName:'{"text":"紅隊蠹魚","color":"red"}',CustomNameVisible:1b,Tags:["bedwars","no_loop"]}
execute as @s[tag=yellowfish_marker] unless score @s num matches 1 run summon silverfish ~ ~0.1 ~ {CustomName:'{"text":"黃隊蠹魚","color":"yellow"}',CustomNameVisible:1b,Tags:["bedwars","no_loop"]}
execute as @s[tag=greenfish_marker] unless score @s num matches 1 run summon silverfish ~ ~0.1 ~ {CustomName:'{"text":"綠隊蠹魚","color":"green"}',CustomNameVisible:1b,Tags:["bedwars","no_loop"]}
