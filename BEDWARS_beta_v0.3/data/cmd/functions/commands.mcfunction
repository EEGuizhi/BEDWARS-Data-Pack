...
tellraw @a {"text":"   ","extra":[{"text":" [設置鑽石點] ","color":"aqua","clickEvent":{"action":"run_command","value":"/function bedwars:setpoint/diamond"}},{"text":" [設置綠寶石點] ","color":"green","clickEvent":{"action":"run_command","value":"/function bedwars:setpoint/emerald"}}]}
tellraw @a {"text":">> 設置商人："}
...
tellraw @a {"text":">> 設置床點："}
tellraw @a {"text":"   ","extra":[{"text":" (直接放置該隊顏色的床即可 設置成功會跳出提示)  ","bold":true,"color":"gray"}]}
