...
execute as @s[team=blue] if score @e[tag=resource,limit=1,team=blue] num matches 1.. run give @s diamond 4
...
execute as @s[team=red] if score @e[tag=resource,limit=1,team=red] num matches 1.. run give @s diamond 4
...
execute as @s[team=yellow] if score @e[tag=resource,limit=1,team=yellow] num matches 1.. run give @s diamond 4
...
execute as @s[team=green] if score @e[tag=resource,limit=1,team=green] num matches 1.. run give @s diamond 4
