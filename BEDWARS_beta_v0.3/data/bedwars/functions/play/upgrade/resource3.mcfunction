...
execute as @s[team=blue] unless score @e[tag=resource,limit=1,team=blue] num matches 2 run give @s diamond 12
...
execute as @s[team=red] unless score @e[tag=resource,limit=1,team=red] num matches 2 run give @s diamond 12
...
execute as @s[team=yellow] unless score @e[tag=resource,limit=1,team=yellow] num matches 2 run give @s diamond 12
...
execute as @s[team=green] unless score @e[tag=resource,limit=1,team=green] num matches 2 run give @s diamond 12
