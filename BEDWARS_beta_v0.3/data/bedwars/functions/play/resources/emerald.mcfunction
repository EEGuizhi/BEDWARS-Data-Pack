...
# 55秒
execute if score @s num matches ..1 positioned ~ ~-2 ~ unless entity @e[nbt={Item:{id:"minecraft:emerald",Count:8b}},distance=..3] run summon item ~ ~ ~ {Item:{id:"minecraft:emerald",Count:1},Tags:["bedwars","no_loop"]}
