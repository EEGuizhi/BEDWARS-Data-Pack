...
execute if score @s times matches 1 positioned ~ ~-1 ~ store result score @s Tmp run execute if entity @e[nbt={Item:{id:"minecraft:iron_ingot",Count:64b}},distance=..3]
execute if score @s times matches 1 unless score @s Tmp matches 2.. run summon item ^ ^ ^0.2 {Item:{id:"minecraft:iron_ingot",Count:1},Tags:["bedwars","no_loop"]}
